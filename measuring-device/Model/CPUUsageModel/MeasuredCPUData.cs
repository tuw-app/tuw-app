...
namespace MeasureDeviceProject.Model.CPUUsageModel
{
    public class MeasuredCPUData
    {
        ...
        public MeasuredCPUData(MDIPAddress iPAddress, string year, string month, string day, string hour, string minute, string second, string cPUUsage)
        {
            IPAddress = iPAddress;
            Year = year;
            Month = month;
        ...
        public MeasuredCPUData(MeasuredCPUDataStore measuredCPUDataStore)
        {
